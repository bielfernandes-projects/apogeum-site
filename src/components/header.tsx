...
export function Header() {
  ...
  const navItems = [
    { key: "diferenciais", href: "#diferenciais", label: t("diferenciais") },
    { key: "portfolio", href: "#portfolio", label: t("portfolio") },
    { key: "processo", href: "#processo", label: t("processo") },
    { key: "contato", href: "#contato", label: t("contato") },
  ];
    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-md border-b border-border">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <button
          ...
          aria-label={open ? tCommon("fecharMenu") : tCommon("abrirMenu")}
        >
